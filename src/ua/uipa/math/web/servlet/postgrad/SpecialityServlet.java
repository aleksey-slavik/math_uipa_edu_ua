...
public class SpecialityServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -9175925777564770315L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(lang == null){
			...
			response.sendRedirect("postgrad_speciality");
		}
		else
	...
	private static String getSpecialityHull(String branch, String speciality,
			String[] info, String[] skill, String[] act) {
		String res = "<div class='Information'>" + 
				...
				"<p align='justify' class='Name'><strong>" + info[3] + "</strong></p>" +
				"<ul>";
		for(String s : skill)
			res += "<li><div align='justify' class='Name'>" + s + "</div></li>";
		res += "</ul><p align='justify' class='Name'>" + info[4] + "</p>" +
				"<p align='justify' class='Name'><strong>" + info[5] + "</strong></p><ul>";
		for(String s : act)
			res += "<li><div align='justify' class='Name'>" + s + "</div></li>";
		res += "</ul><p align='justify' class='Name'><strong>" + info[6] + "</strong></p></div>";
		return res;
	}
}
